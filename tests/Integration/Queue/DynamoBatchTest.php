...
class DynamoBatchTest extends TestCase
{
    ...
    public function test_retrieve_batch_by_id()
    {
        ...
        $this->assertTrue($retrieved->finishedAt->between(Carbon::now()->subSeconds(30), Carbon::now()));
    }
    ...
    public function test_batch_with_failing_job()
    {
        ...
        $this->assertTrue($retrieved->finishedAt->between(Carbon::now()->subSeconds(30), Carbon::now()));
        $this->assertTrue($retrieved->cancelledAt->between(Carbon::now()->subSeconds(30), Carbon::now()));
    }
